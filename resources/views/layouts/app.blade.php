						...
						<div class- "container">
							<div class="row">
								<div class="col-xs-6">
									...
									<div class="form-group spacinga">
										<input class="forInput form-control" type="email" name="salesperemail" ng-model="Sperson.email" ng-class="{submitting: addSalespersonform.salesperemail.$error.required && addSalespersonform.salesperemail.$touched }"
									...
									<div class=" form-group spacinga">
										<input class="forInput form-control" type="text" only-letters-input name="salesperpos" ng-model="Sperson.pos" ng-class="{submitting: addSalespersonform.salesperpos.$error.required && addSalespersonform.salesperpos.$touched }"
	...
	<script type="text/ng-template" id="changepasswordmodal.html">
		<div class="modal-content">
			...
			<form id="chpassform" name="changepassformin" novalidate class="form-group">
				<div class="modal-body">
					<div class="form-group spacinga">
						<input type="password" required name="usernewpass" ng-model="user.newpass" ng-class="{submitting: changepassformin.usernewpass.$error.required && changepassformin.usernewpass.$touched }"
					...
					<div class="form-group spacinga">
						<input type="password" ng-class="{submitting: ((changepassformin.userpasswordconf.$error.required || changepassformin.userpasswordconf.$error.compareTo && user.password)  && changepassformin.userpasswordconf.$touched )}"
						 name="userpasswordconf" ng-model="user.passconf" class="form-control forInput" placeholder="Confirm Password" compare-to="user.password"
						 required>
				...
				<div class="modal-body" style="overflow-y: auto; max-height:450px;">
					...
					<div class="form-group spacingedit">
						...
						<input class="forInput form-control" type="text" ng-pattern="/^(((ht|f)tp(s?))\://)?(www.|[a-zA-Z].)[a-zA-Z0-9\-\.]+\.(com|edu|gov|mil|net|org|biz|info|name|museum|us|ca|uk)(\:[0-9]+)*(/($|[a-zA-Z0-9\.\,\;\?\'\\\+&amp;%\$#\=~_\-]+))*$/"
						 name="companyWebsite" ng-model="editcom.companyWebsite" placeholder="Company Website" ng-class="{submitting:editcompany.companyWebsite.$error.required && editcompany.companyWebsite.$touched}"
						 required>
					...
					<div class="form-group spacingedit">
						...
						<select class="forInput form-control" name="industry" ng-model="editcom.industry" ng-class="{submitting:editcompany.industry.$error.required && editcompany.industry.$touched}"
						 required>
					...
					<div class="form-group spacingedit">
						...
						<textarea class="forInput form-control" wrap="soft" rows="5" type="text" size="255" placeholder="Address" ng-model="editcom.companyAddress"
						 name="companyAddress" ng-class="{submitting:editcompany.companyAddress.$error.required && editcompany.companyAddress.$touched}"
						 required></textarea>
						<div class="errormainpage">
			...
			<form id="editContact" name="editContact" class="form-group" novalidate>
				<div class="modal-body" style="overflow-y: auto; max-height:450px;">
					...
					<div class="form-group">
						...
						<input class="forInput form-control" only-letters-input type="text" name="contactPerson" ng-model="editcont.contactPerson"
					...
					<div class="form-group spacingedit" id="registerpassword">
						...
						<input class="forInput form-control" type="text" name="contPerPhone" ng-maxlength="15" ng-model="editcont.contPerPhone" placeholder="Contact Person Phone Number"
						 ng-class="{submitting:((editContact.contPerPhone.$error.required || editContact.contPerPhone.$error.maxlength) && editContact.contPerPhone.$touched)}"
				...
				<div class="modal-body" style="overflow-y: auto; max-height:450px;">
					<div class="form-inline spacingedit">
						...
						<div class="form-group">
							...
							<select class="forInput form-control form-group" name="salesPerson" ng-model="editDealProj.salesPerson" ng-class="{submitting:editDeal.salesPerson.$error.required && editDeal.salesPerson.$touched}"
							 required>
					...
					<div class="form-inline spacinga">
						...
						<div class="form-group">
							...
							<select class="forInput form-control" ng-model="editDealProj.product" name="product" ng-class="{submitting:editDeal.product.$error.required && editDeal.product.$touched}"
							 required>
					...
					<div class="form-inline spacinga">
						...
						<div class="form-group">
							...
							<input class="forInput form-control" type="text" name="salesStage" ng-pattern="/^[0-9][0-9]?$|^100$/" restrict-to="[0-9]"
							 ng-model="editDealProj.salesStage" placeholder="Sales Stage in Percentage" name="value" ng-class="{submitting:((editDeal.salesStage.$error.required  || editDeal.salesStage.$error.pattern) && editDeal.salesStage.$touched)}"
							 required>
					...
					<div class="spacing" id="sub-rightedit">
						<div class="form-group">
							...
							<div class="datepicker modaldate" date-format="dd/MM/yyyy">
								<input class="forInput form-control modaldatepicker" onkeypress="return false;" ng-model="editDealProj.podate" type="text"
					...
					<div id="sub-left">
						<div class="form-group">
							...
							<div class="datepicker modaldate form-group" date-format="dd/MM/yyyy">
								<input class="forInput form-control modaldatepicker " onkeypress="return false;" ng-model="editDealProj.startdate" type="text"
					...
					<div id="sub-rightedit">
						<div class="form-group">
							...
							<div class="datepicker modaldate" date-format="dd/MM/yyyy">
								<input class="forInput form-control modaldatepicker" onkeypress="return false;" ng-model="editDealProj.enddate" type="text"
				...
				<div class="modal-body" style="overflow-y: auto; max-height:450px;">
					...
					<div class="SectionBox">
						...
						<div ng-show="showAdd">
								...
								<div class="form-inline">
									<div class="form-group">
										<input class="forInput form-control" type="text" name="addCompanyName" ng-model="Dealproj.addCompanyName" placeholder="Company name"
										 ng-class="{submitting:addDeal.addCompanyName.$error.required && addDeal.addCompanyName.$touched &&  !Dealproj.companyID}"
										 required>
										<div class="errormainpage">
									...
									<div class="form-group">
										<input class="forInput form-control" type="text" ng-pattern="/^(((ht|f)tp(s?))\://)?(www.|[a-zA-Z].)[a-zA-Z0-9\-\.]+\.(com|edu|gov|mil|net|org|biz|info|name|museum|us|ca|uk)(\:[0-9]+)*(/($|[a-zA-Z0-9\.\,\;\?\'\\\+&amp;%\$#\=~_\-]+))*$/"
										 name="companyWebsite" ng-model="Dealproj.companyWebsite" placeholder="Company Website" ng-class="{submitting:addDeal.companyWebsite.$error.required && addDeal.companyWebsite.$touched &&  !Dealproj.companyID}"
										 required>
								...
								<div class="form-inline">
									...
									<div class="form-group">
										<input class="forInput form-control" type="text" name="companyAddress" ng-model="Dealproj.companyAddress" placeholder="Company Address"
										 ng-class="{submitting:addDeal.companyAddress.$error.required && addDeal.companyAddress.$touched &&  !Dealproj.companyID}"
										 required>
										<div class="errormainpage">
							...
							<div class="form-group spacinga">
								<div class="form-inline">
									<div class="form-group">
										<select class="forInput form-control" name="industry" ng-model="Dealproj.industry" ng-class="{submitting:addDeal.industry.$error.required && addDeal.industry.$touched &&  !Dealproj.companyID}"
										 required>
											<option value="" default disabled selected>Select the Industry</option>
										</select>
										<div class="errormainpage">
									...
									<div class="form-group">
										<input class="forInput form-control" only-letters-input type="text" name="contactPerson" ng-model="Dealproj.contactPerson"
								...
								<div class="form-inline">
									...
									<div class="form-group" id="registerpassword">
										<input class="forInput form-control" type="text" name="contPerPhone" ng-maxlength="15" ng-model="Dealproj.contPerPhone" placeholder="Contact Person Phone Number"
										 ng-class="{submitting:((addDeal.contPerPhone.$error.required || addDeal.contPerPhone.$error.maxlength) && addDeal.contPerPhone.$touched && !Dealproj.companyID)}"
										 required popover="Example: 0172345464" popover-placement="bottom" popover-trigger="mouseenter" restrict-to="[0-9]">
					...
					<div class="SectionBox">
						...
						<div class="form-group">
							<div class="form-inline">
								<div class="form-group">
									<select class="forInput form-control" name="salesPerson" ng-model="Dealproj.salesPerson" ng-class="{submitting:addDeal.salesPerson.$error.required && addDeal.salesPerson.$touched}"
									 required>
										<option value="" default disabled selected>Select the Person in Charge</option>
									</select>
									<div class="errormainpage">
						...
						<div class="form-group spacinga">
							<div class="form-inline">
								<div class="form-group">
									<select class="forInput form-control" ng-model="Dealproj.product" name="product" ng-class="{submitting:addDeal.product.$error.required && addDeal.product.$touched}"
									 required>
										<option value="" default disabled selected>Select the Product</option>
									</select>
									<div class="errormainpage">
						...
						<div class="spacinga">
							<div class="form-inline">
								<div class="form-group">
									<input class="forInput form-control" type="text" name="salesStage" ng-pattern="/^[0-9][0-9]?$|^100$/" restrict-to="[0-9]"
									 ng-model="Dealproj.salesStage" placeholder="Sales Stage in Percentage" name="value" ng-class="{submitting:((addDeal.salesStage.$error.required  || addDeal.salesStage.$error.pattern) && addDeal.salesStage.$touched)}"
									 required>
						...
						<div id="sub-right" class="spacinga">
							<div class="datepicker modaldate" date-format="dd/MM/yyyy">
								<input class="forInput form-control modaldatepicker" onkeypress="return false;" ng-model="Dealproj.podate" type="text" placeholder="PO-Date: DD/MM/YYYY"
						...
						<div id="sub-right" class="spacinga">
							<div class="datepicker modaldate" date-format="dd/MM/yyyy">
								<input class="forInput form-control modaldatepicker" onkeypress="return false;" ng-model="Dealproj.startdate" type="text"
						...
						<div id="sub-right" class="spacinga">
							<div class="datepicker modaldate" date-format="dd/MM/yyyy">
								<input class="forInput form-control modaldatepicker" onkeypress="return false;" ng-model="Dealproj.enddate" type="text" placeholder="End Date: DD/MM/YYYY"
								 name="enddate">
								<i class="fa fa-calendar fafaPosititionondatepicker"></i>
								</input>
							</div>
				...
				<div class="modal-body" style="overflow-y: auto; max-height:400px;">
					...
					<div class="form-inline spacingedit">
						<div class="form-group">
							...
							<select class="forInput form-control" ng-model="editLeadProj.companyID" ng-options="company.id as company.name for company in companies"
							 ng-disabled="true">
								<option value="" default disabled selected>Select the Company</option>
							</select>
						</div>
					...
					<div class="form-inline spacinga">
						<div class="form-group">
							...
							<select class="forInput form-control" ng-model="editLeadProj.product" name="product" ng-class="{submitting:editLead.product.$error.required && editLead.product.$touched}"
							 required>
								<option value="" default disabled selected>Select the Product</option>
							</select>
							<div class="errormainpage">
					...
					<div class="form-inline spacinga">
						<div class="form-group">
							...
							<input class="forInput form-control" type="text" name="salesStage" ng-pattern="/^[0-9][0-9]?$|^100$/" restrict-to="[0-9]"
							 ng-model="editLeadProj.salesStage" placeholder="Sales Stage in Percentage" name="value" ng-class="{submitting:((editLead.salesStage.$error.required  || editLead.salesStage.$error.pattern) && editLead.salesStage.$touched)}"
							 required>
					...
					<div class="form-inline spacinga">
						<div class="form-group">
							...
							<div class="datepicker modaldate form-group" date-format="dd/MM/yyyy">
								<input class="forInput form-control modaldatepicker " onkeypress="return false;" ng-model="editLeadProj.startdate" type="text"
						...
						<div class="form-group">
							...
							<div class="datepicker modaldate" date-format="dd/MM/yyyy">
								<input class="forInput form-control modaldatepicker" onkeypress="return false;" ng-model="editLeadProj.enddate" type="text"
								 placeholder="End Date: DD/MM/YYYY" name="enddate">
								<i class="fa fa-calendar fafaPosititionondatepicker"></i>
								</input>
							</div>
					...
					<div ng-show="projectCat.catID=='1'">
						<div class="form-inline spacinga">
							...
							<div class="form-group">
								...
								<div class="datepicker modaldate" date-format="dd/MM/yyyy">
									<input class="forInput form-control modaldatepicker" onkeypress="return false;" ng-model="editLeadProj.podate" type="text"
					...
					<div class="spacinga" ng-hide="projectCat.catID =='2'">
						<div id="sub-rightedit">
							<div class="form-group">
								...
								<select class="forInput form-control" name="salesPerson" ng-model="editLeadProj.salesPerson" ng-class="{submitting:editLead.salesPerson.$error.required && editLead.salesPerson.$touched}"
								 required>
									<option value="" default disabled selected>Select the Person in Charge</option>
								</select>
				...
				<div class="modal-body" style="overflow-y: auto; max-height:450px;">
					...
					<div class="form-inline spacinga">
						<div class="form-group">
							...
							<div class="datepicker modaldate form-group" date-format="dd/MM/yyyy">
								<input class="forInput form-control modaldatepicker " onkeypress="return false;" ng-model="editlostProj.startdate" type="text"
			...
			<form id="editsalesperson" name="editsalesperson" class="form-group" novalidate>
				<div class="modal-body" style="overflow-y: auto; max-height:450px;">
					...
					<div class="form-group spacingedit">
						...
						<input class="forInput form-control" type="text" only-letters-input name="salesperpos" ng-model="editSperson.pos" ng-class="{submitting: editsalesperson.salesperpos.$error.required && editsalesperson.salesperpos.$touched }"
						 placeholder="Position" required>
		...
		<div>
			...
			<form class="form-group" name="forgotpass" novalidate>
				<div class="modal-body" style="height:120px;">
					...
					<div>
						<input class="form-control forInput" id="email" name="email" ng-model="user.email" type="email" placeholder="Email"  ng-class="{submitting: forgotpass.email.$touched}" required>
